  ...
  return (
    <section className="py-16 lg:py-24 border-b border-slate-border/60 relative bg-canvas overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Section Header: Bold & Authoritative */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-10">
          ...
          {/* ======================================================================= */}
          <div className="lg:col-span-7 rounded-2xl border border-slate-border/80 bg-canvas-card/90 hover:border-brand-red/60 transition-all duration-300 shadow-xl overflow-hidden group flex flex-col justify-between relative">
            ...
            <div className="p-6 sm:p-8 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                {/* Headline */}
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight mb-3 group-hover:text-brand-redLight transition-colors">
              ...
              <div className="pt-4 border-t border-slate-border/80 flex flex-wrap items-center justify-between gap-4">
          ...
          {/* ======================================================================= */}
          <div className="lg:col-span-5 rounded-2xl border border-slate-border/80 bg-canvas-card/90 hover:border-brand-red/60 transition-all duration-300 shadow-xl overflow-hidden group flex flex-col justify-between relative">
            
            <div className="p-6 sm:p-7 relative z-10 flex flex-col justify-between h-full">
              <div>
                {/* Badge Header */}
                <div className="flex items-center justify-between gap-2 mb-4">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[11px] px-2 py-0.5 rounded bg-emerald-950/60 text-emerald-400 border border-emerald-800/50 font-bold">
                    ±0.01 mm Presisi
                  </span>
                </div>
                ...
                <div className="relative rounded-xl overflow-hidden border border-slate-700/80 mb-4 h-40 bg-black">
                  <img
                  ...
                  <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between text-[11px] font-mono text-slate-200">
              ...
              <div className="pt-3 border-t border-slate-border/80 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-mono">Drawing CAD / Sampel Fisik</span>
                <Link
                  to="/contact"
            ...
            <div className="p-6 sm:p-7 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-4">
                  ...
                  <span className="font-mono text-[11px] px-2 py-0.5 rounded bg-amber-950/60 text-amber-400 border border-amber-800/50 font-semibold">
                    Standar K3 Pabrik
                  </span>
                </div>
                ...
                <div className="relative rounded-xl overflow-hidden border border-slate-700/80 mb-4 h-40 bg-black">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-canvas/90 via-transparent to-transparent" />
                  <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between text-[11px] font-mono text-slate-200">
                    <span>Cable Ladder & Perforated Tray</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-slate-300 mb-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Pemisahan Power & Sinyal</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <Check className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                    <span>Safety Load Calculation</span>
                  </div>
                </div>
              </div>
              ...
              {/* Card Footer: Action Link */}
              <div className="pt-3 border-t border-slate-border/80 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-mono">Daya & Sinyal Instrumentasi</span>
                <Link
          ...
          <div className="lg:col-span-7 rounded-2xl border border-slate-border/80 bg-canvas-card/90 hover:border-brand-red/60 transition-all duration-300 shadow-xl overflow-hidden group flex flex-col justify-between relative">
            ...
            <div className="p-6 sm:p-8 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                {/* Headline */}
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight mb-3 group-hover:text-sky-300 transition-colors">
                ...
                {/* 3 Pillar Category Highlights */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                  <div className="p-3 rounded-lg bg-canvas/70 border border-slate-700/60">
                    <span className="font-mono text-[11px] font-bold text-sky-400 block mb-1">Otomasi & Kontrol</span>
                    <span className="text-[11px] text-slate-300 block leading-snug">Mitsubishi, Yaskawa, Fuji, Autonics, Cognex</span>
                  </div>
                  <div className="p-3 rounded-lg bg-canvas/70 border border-slate-700/60">
                    <span className="font-mono text-[11px] font-bold text-sky-400 block mb-1">Motion & Bearing</span>
                    <span className="text-[11px] text-slate-300 block leading-snug">THK, NSK, Timken, NTN, IKO, Koyo, FAG</span>
                  </div>
                  <div className="p-3 rounded-lg bg-canvas/70 border border-slate-700/60">
                    <span className="font-mono text-[11px] font-bold text-sky-400 block mb-1">Pneumatik & Transmisi</span>
                    <span className="text-[11px] text-slate-300 block leading-snug">Koganei, Tsubaki, Nitta Moore, Samick</span>
                  </div>
                </div>
              </div>
        ...
        {/* Unified Bottom Assurance Strip */}
        <div className="p-4 sm:p-5 rounded-xl bg-canvas-card border border-slate-border/80 flex flex-wrap items-center justify-between gap-4 text-xs">
          <div className="flex flex-wrap items-center gap-6 text-slate-300 font-mono">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-brand-red hover:bg-brand-redDark text-white font-semibold transition-all shadow-md shadow-brand-red/20"
          >
