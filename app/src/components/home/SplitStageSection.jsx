  ...
  return (
    <section className="py-8 sm:py-16 lg:py-24 border-b border-slate-border/60 relative bg-canvas overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="p-3.5 sm:p-6 sm:p-8 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-2.5 sm:mb-4">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="font-mono text-xs font-bold text-brand-redLight tracking-wider uppercase">
                ...
                {/* Headline */}
                <h3 className="text-lg sm:text-2xl font-bold text-white tracking-tight mb-2 sm:mb-3 group-hover:text-brand-redLight transition-colors">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5 mb-3 sm:mb-6">
                  {pAutomation.deliverables.slice(0, 4).map((item, idx) => (
                    <div key={idx} className={`items-start gap-2 text-xs sm:text-sm text-slate-200 ${idx >= 2 ? 'hidden sm:flex' : 'flex'}`}>
              ...
              <div className="pt-3 sm:pt-4 border-t border-slate-border/80 flex flex-wrap items-center justify-between gap-3 sm:gap-4">
                <div className="hidden sm:flex flex-wrap items-center gap-1.5">
                  <span className="text-xs font-mono text-slate-400 mr-1">Controllers:</span>
                  {["Mitsubishi", "Omron", "Allen-Bradley", "Yaskawa"].map((b, i) => (
                    <span key={i} className="text-xs font-mono px-2 py-0.5 rounded bg-canvas-subtle/80 text-slate-300 border border-slate-700/60">
                      {b}
                    </span>
                  ))}
                </div>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-brand-redLight hover:text-white transition-colors group/link"
                >
            ...
            <div className="p-3.5 sm:p-6 sm:p-7 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-2.5 sm:mb-4">
                  ...
                  <span className="font-mono text-xs px-2 py-0.5 rounded bg-emerald-950/60 text-emerald-400 border border-emerald-800/50 font-bold">
                    ±0.01 mm Presisi
                  </span>
                </div>

                <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight mb-2 group-hover:text-emerald-300 transition-colors">
                ...
                <div className="relative rounded-xl overflow-hidden border border-slate-700/80 mb-3 sm:mb-4 h-28 sm:h-40 bg-black">
                  ...
                  <div className="hidden sm:flex absolute bottom-2 left-3 right-3 items-center justify-between text-xs font-mono text-slate-200">
                ...
                <div className="hidden sm:flex flex-wrap gap-1.5 mb-4">
                  {["Shaft Bertingkat", "Gear & Sprocket", "Flange Hydraulic", "Bushing Bronze", "S45C / SUS304"].map((tag, idx) => (
                    <span key={idx} className="text-xs font-mono px-2 py-0.5 rounded bg-canvas-subtle text-slate-300 border border-slate-700/60">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="pt-3 border-t border-slate-border/80 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-mono hidden xs:inline">Drawing CAD / Sampel Fisik</span>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-emerald-400 hover:text-white transition-colors group/link"
                >
            ...
            <div className="p-3.5 sm:p-6 sm:p-7 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-2.5 sm:mb-4">
                  ...
                  <span className="font-mono text-xs px-2 py-0.5 rounded bg-amber-950/60 text-amber-400 border border-amber-800/50 font-semibold">
                    Standar K3 Pabrik
                  </span>
                </div>

                <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight mb-2 group-hover:text-amber-300 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-slate-300 mb-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs">Pemisahan Power & Sinyal</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <Check className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                    <span className="text-xs">Safety Load Calculation</span>
                  </div>
                </div>
              </div>
              ...
              {/* Card Footer: Action Link */}
              <div className="pt-3 border-t border-slate-border/80 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-mono hidden xs:inline">Daya & Sinyal Instrumentasi</span>
                <Link
                  to="/services#fabrication"
                  className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-amber-400 hover:text-white transition-colors group/link"
                >
          ...
          >
            ...
            <div className="p-3.5 sm:p-6 sm:p-8 relative z-10 flex flex-col justify-between h-full">
              <div>
                ...
                {/* Headline */}
                <h3 className="text-lg sm:text-2xl font-bold text-white tracking-tight mb-2 sm:mb-3 group-hover:text-sky-300 transition-colors">
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-3 mb-3 sm:mb-6">
                  <div className="p-2 sm:p-3 rounded-lg bg-canvas/70 border border-slate-700/60 text-center sm:text-left">
                    <span className="font-mono text-xs font-bold text-sky-400 block sm:mb-1 leading-tight">Otomasi & Kontrol</span>
                    <span className="text-xs text-slate-300 block leading-snug hidden sm:block">Mitsubishi, Yaskawa, Fuji, Autonics, Cognex</span>
                  </div>
                  <div className="p-2 sm:p-3 rounded-lg bg-canvas/70 border border-slate-700/60 text-center sm:text-left">
                    <span className="font-mono text-xs font-bold text-sky-400 block sm:mb-1 leading-tight">Motion & Bearing</span>
                    <span className="text-xs text-slate-300 block leading-snug hidden sm:block">THK, NSK, Timken, NTN, IKO, Koyo, FAG</span>
                  </div>
                  <div className="p-2 sm:p-3 rounded-lg bg-canvas/70 border border-slate-700/60 text-center sm:text-left">
                    <span className="font-mono text-xs font-bold text-sky-400 block sm:mb-1 leading-tight">Pneumatik & Transmisi</span>
                    <span className="text-xs text-slate-300 block leading-snug hidden sm:block">Koganei, Tsubaki, Nitta Moore, Samick</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-3 sm:pt-4 border-t border-slate-border/80 flex flex-wrap items-center justify-between gap-3 sm:gap-4">
                ...
                <Link
                  to="/products"
                  className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-sky-400 hover:text-white transition-colors group/link"
                >
        ...
        >
          <div className="flex flex-col sm:flex-row flex-wrap sm:items-center gap-2 sm:gap-6 text-slate-300 font-mono text-xs sm:text-xs">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-brand-red hover:bg-brand-redDark text-white font-semibold transition-all shadow-md shadow-brand-red/20 w-full sm:w-auto text-center text-sm"
            >
