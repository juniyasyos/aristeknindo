...
const aboutDataContent = `export const ABOUT_DATA = {
  header: {
...
fs.writeFileSync(path.join(process.cwd(), 'app/src/data/aboutData.js'), aboutDataContent, 'utf-8');
console.log('Successfully generated app/src/data/aboutData.js');
